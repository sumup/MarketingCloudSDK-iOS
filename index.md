...
* **Better tracking of open from push analytics**—The tracking of "open from push" analytics when an application is not running will now be captured more effectively when the SDK is configured asynchronously.
